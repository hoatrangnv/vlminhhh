        ...
        <div class="row">
            ...
            <div class="mb-3 col-sm-6">
                ...
                <div class="alert alert-success" role="alert">Số Điện Thoại: <b><a href="javascript:;"
                            onclick="copyMomo;"><b>0367644190 </b><i class="far fa-copy"></i>
                        </a>
                    </b>
                    <br>Chủ tài khoản: <b>BUI VAN TAN</b>
            ...
            <div class="col-md-12">
                ...
                <div class="alert alert-info" role="alert">
                    <h4 class="alert-heading font-weight-semi-bold text-center">
                        <a href="javascript:;" onclick="copyContent();"><b>likesub123 <?=$user_username;?></b>&nbsp;<i
...
function copyContent() {
    var text = "likesub123 <?=$user_username;?>";
    copy(text);
    swal('Đã copy nội dung chuyển khoản Momo!', 'success');
}
</script>
